...
var values = [
    10, 25, 46, 80, 111, 120, 142, 189, 210, 222, 239, 264, 300
];

var maxHeight = window.innerHeight / 3.618;
var maxValue = values.reduce((m, c) => Math.max(m, c), 0);
var el = document.getElementById('chart');
var markup = values.map((value, index) =>
        `<li style="height: ${maxHeight / (maxValue / value)}px"
                       class="chart__column">
